...
Query::Query()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:first_package.Query)
}
...
Query::Query(const Query& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:first_package.Query)
}
...
Query::~Query() {
  // @@protoc_insertion_point(destructor:first_package.Query)
  SharedDtor();
}
...
void Query::Clear() {
// @@protoc_insertion_point(message_clear_start:first_package.Query)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:first_package.Query)
  for (;;) {
        ...
        if (tag == 18) {
         parse_questioner:
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            ...
            "first_package.Query.questioner");
        } else {
          goto handle_unusual;
        }
...
success:
  // @@protoc_insertion_point(parse_success:first_package.Query)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:first_package.Query)
  return false;
#undef DO_
}
...
void Query::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:first_package.Query)
  // required int64 id = 1;
  if (has_id()) {
  ...
  // @@protoc_insertion_point(serialize_end:first_package.Query)
}

::google::protobuf::uint8* Query::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:first_package.Query)
  // required int64 id = 1;
  if (has_id()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:first_package.Query)
  return target;
}

int Query::RequiredFieldsByteSizeFallback() const {
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:first_package.Query)
  int total_size = 0;
...
// @@protoc_insertion_point(message_byte_size_start:first_package.Query)
  int total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:first_package.Query)
  ...
  const Query* source = 
      ::google::protobuf::internal::DynamicCastToGenerated<const Query>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:first_package.Query)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:first_package.Query)
    MergeFrom(*source);
  }
}

void Query::MergeFrom(const Query& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:first_package.Query)
  if (GOOGLE_PREDICT_FALSE(&from == this)) {
    ::google::protobuf::internal::MergeFromFail(__FILE__, __LINE__);
  }
...
// @@protoc_insertion_point(generalized_copy_from_start:first_package.Query)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:first_package.Query)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void Query::clear_id() {
 ...
 ::google::protobuf::int64 Query::id() const {
  // @@protoc_insertion_point(field_get:first_package.Query.id)
  return id_;
}
 void Query::set_id(::google::protobuf::int64 value) {
  set_has_id();
  id_ = value;
  // @@protoc_insertion_point(field_set:first_package.Query.id)
}
...
void Query::clear_questioner() {
 ...
 const ::std::string& Query::questioner() const {
  // @@protoc_insertion_point(field_get:first_package.Query.questioner)
 ...
 void Query::set_questioner(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:first_package.Query.questioner)
}
 void Query::set_questioner(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:first_package.Query.questioner)
}
 void Query::set_questioner(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:first_package.Query.questioner)
}
 ::std::string* Query::mutable_questioner() {
  set_has_questioner();
  // @@protoc_insertion_point(field_mutable:first_package.Query.questioner)
 ...
 ::std::string* Query::release_questioner() {
  // @@protoc_insertion_point(field_release:first_package.Query.questioner)
  clear_has_questioner();
 ...
 void Query::set_allocated_questioner(::std::string* questioner) {
  ...
  // @@protoc_insertion_point(field_set_allocated:first_package.Query.questioner)
}
...
void Query::clear_question() {
 ...
 const ::std::string& Query::question(int index) const {
  // @@protoc_insertion_point(field_get:first_package.Query.question)
  return question_.Get(index);
}
 ::std::string* Query::mutable_question(int index) {
  // @@protoc_insertion_point(field_mutable:first_package.Query.question)
  return question_.Mutable(index);
}
 void Query::set_question(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:first_package.Query.question)
  question_.Mutable(index)->assign(value);
}
 void Query::set_question(int index, const char* value) {
  question_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:first_package.Query.question)
}
 void Query::set_question(int index, const char* value, size_t size) {
  question_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:first_package.Query.question)
}
 ::std::string* Query::add_question() {
  // @@protoc_insertion_point(field_add_mutable:first_package.Query.question)
  return question_.Add();
}
 void Query::add_question(const ::std::string& value) {
  question_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:first_package.Query.question)
}
 void Query::add_question(const char* value) {
  question_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:first_package.Query.question)
}
 void Query::add_question(const char* value, size_t size) {
  question_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:first_package.Query.question)
}
 const ::google::protobuf::RepeatedPtrField< ::std::string>&
Query::question() const {
  // @@protoc_insertion_point(field_list:first_package.Query.question)
  return question_;
}
 ::google::protobuf::RepeatedPtrField< ::std::string>*
Query::mutable_question() {
  // @@protoc_insertion_point(field_mutable_list:first_package.Query.question)
  return &question_;
}
...
Answer::Answer()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:first_package.Answer)
}
...
Answer::Answer(const Answer& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:first_package.Answer)
}
...
Answer::~Answer() {
  // @@protoc_insertion_point(destructor:first_package.Answer)
  SharedDtor();
}
...
void Answer::Clear() {
// @@protoc_insertion_point(message_clear_start:first_package.Answer)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:first_package.Answer)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
        ...
        if (tag == 18) {
         parse_questioner:
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            this->questioner().data(), this->questioner().length(),
            ::google::protobuf::internal::WireFormat::PARSE,
            "first_package.Answer.questioner");
        } else {
          goto handle_unusual;
        }
...
success:
  // @@protoc_insertion_point(parse_success:first_package.Answer)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:first_package.Answer)
  return false;
#undef DO_
}
...
void Answer::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:first_package.Answer)
  // required int64 id = 1;
  if (has_id()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt64(1, this->id(), output);
  }
  ...
  // @@protoc_insertion_point(serialize_end:first_package.Answer)
}

::google::protobuf::uint8* Answer::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:first_package.Answer)
  // required int64 id = 1;
  if (has_id()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt64ToArray(1, this->id(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:first_package.Answer)
  return target;
}

int Answer::RequiredFieldsByteSizeFallback() const {
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:first_package.Answer)
  int total_size = 0;
...
// @@protoc_insertion_point(message_byte_size_start:first_package.Answer)
  int total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:first_package.Answer)
  if (GOOGLE_PREDICT_FALSE(&from == this)) {
    ::google::protobuf::internal::MergeFromFail(__FILE__, __LINE__);
  }
  const Answer* source = 
      ::google::protobuf::internal::DynamicCastToGenerated<const Answer>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:first_package.Answer)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:first_package.Answer)
    MergeFrom(*source);
  }
}

void Answer::MergeFrom(const Answer& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:first_package.Answer)
  if (GOOGLE_PREDICT_FALSE(&from == this)) {
    ::google::protobuf::internal::MergeFromFail(__FILE__, __LINE__);
  }
...
// @@protoc_insertion_point(generalized_copy_from_start:first_package.Answer)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:first_package.Answer)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void Answer::clear_id() {
 ...
 ::google::protobuf::int64 Answer::id() const {
  // @@protoc_insertion_point(field_get:first_package.Answer.id)
  return id_;
}
 void Answer::set_id(::google::protobuf::int64 value) {
  set_has_id();
  id_ = value;
  // @@protoc_insertion_point(field_set:first_package.Answer.id)
}
...
void Answer::clear_questioner() {
 ...
 const ::std::string& Answer::questioner() const {
  // @@protoc_insertion_point(field_get:first_package.Answer.questioner)
  return questioner_.GetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
 void Answer::set_questioner(const ::std::string& value) {
  set_has_questioner();
  questioner_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:first_package.Answer.questioner)
}
 void Answer::set_questioner(const char* value) {
  set_has_questioner();
  questioner_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:first_package.Answer.questioner)
}
 void Answer::set_questioner(const char* value, size_t size) {
  set_has_questioner();
  questioner_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:first_package.Answer.questioner)
}
 ::std::string* Answer::mutable_questioner() {
  set_has_questioner();
  // @@protoc_insertion_point(field_mutable:first_package.Answer.questioner)
  return questioner_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
 ::std::string* Answer::release_questioner() {
  // @@protoc_insertion_point(field_release:first_package.Answer.questioner)
  clear_has_questioner();
  return questioner_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
 void Answer::set_allocated_questioner(::std::string* questioner) {
  ...
  questioner_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), questioner);
  // @@protoc_insertion_point(field_set_allocated:first_package.Answer.questioner)
}
...
void Answer::clear_answerer() {
 ...
 const ::std::string& Answer::answerer() const {
  // @@protoc_insertion_point(field_get:first_package.Answer.answerer)
 ...
 void Answer::set_answerer(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:first_package.Answer.answerer)
}
 void Answer::set_answerer(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:first_package.Answer.answerer)
}
 void Answer::set_answerer(const char* value, size_t size) {
  ...
  answerer_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:first_package.Answer.answerer)
}
 ::std::string* Answer::mutable_answerer() {
  set_has_answerer();
  // @@protoc_insertion_point(field_mutable:first_package.Answer.answerer)
  return answerer_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
 ::std::string* Answer::release_answerer() {
  // @@protoc_insertion_point(field_release:first_package.Answer.answerer)
  clear_has_answerer();
 ...
 void Answer::set_allocated_answerer(::std::string* answerer) {
  ...
  // @@protoc_insertion_point(field_set_allocated:first_package.Answer.answerer)
}
...
void Answer::clear_solution() {
 ...
 const ::std::string& Answer::solution(int index) const {
  // @@protoc_insertion_point(field_get:first_package.Answer.solution)
  return solution_.Get(index);
}
 ::std::string* Answer::mutable_solution(int index) {
  // @@protoc_insertion_point(field_mutable:first_package.Answer.solution)
  return solution_.Mutable(index);
}
 void Answer::set_solution(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:first_package.Answer.solution)
  solution_.Mutable(index)->assign(value);
}
 void Answer::set_solution(int index, const char* value) {
  solution_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:first_package.Answer.solution)
}
 void Answer::set_solution(int index, const char* value, size_t size) {
  solution_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:first_package.Answer.solution)
}
 ::std::string* Answer::add_solution() {
  // @@protoc_insertion_point(field_add_mutable:first_package.Answer.solution)
  return solution_.Add();
}
 void Answer::add_solution(const ::std::string& value) {
  solution_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:first_package.Answer.solution)
}
 void Answer::add_solution(const char* value) {
  solution_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:first_package.Answer.solution)
}
 void Answer::add_solution(const char* value, size_t size) {
  solution_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:first_package.Answer.solution)
}
 const ::google::protobuf::RepeatedPtrField< ::std::string>&
Answer::solution() const {
  // @@protoc_insertion_point(field_list:first_package.Answer.solution)
  return solution_;
}
 ::google::protobuf::RepeatedPtrField< ::std::string>*
Answer::mutable_solution() {
  // @@protoc_insertion_point(field_mutable_list:first_package.Answer.solution)
  return &solution_;
}
...
Empty::Empty()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:first_package.Empty)
}
...
Empty::Empty(const Empty& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:first_package.Empty)
}
...
Empty::~Empty() {
  // @@protoc_insertion_point(destructor:first_package.Empty)
  SharedDtor();
}
...
void Empty::Clear() {
// @@protoc_insertion_point(message_clear_start:first_package.Empty)
  id_ = 0;
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
  if (_internal_metadata_.have_unknown_fields()) {
    mutable_unknown_fields()->Clear();
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:first_package.Empty)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:first_package.Empty)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:first_package.Empty)
  return false;
#undef DO_
}
...
void Empty::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:first_package.Empty)
  // optional int32 id = 1;
  if (has_id()) {
  ...
  // @@protoc_insertion_point(serialize_end:first_package.Empty)
}

::google::protobuf::uint8* Empty::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:first_package.Empty)
  // optional int32 id = 1;
  if (has_id()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:first_package.Empty)
  return target;
}

int Empty::ByteSize() const {
// @@protoc_insertion_point(message_byte_size_start:first_package.Empty)
  int total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:first_package.Empty)
  if (GOOGLE_PREDICT_FALSE(&from == this)) {
    ::google::protobuf::internal::MergeFromFail(__FILE__, __LINE__);
  }
  const Empty* source = 
      ::google::protobuf::internal::DynamicCastToGenerated<const Empty>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:first_package.Empty)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:first_package.Empty)
    MergeFrom(*source);
  }
}

void Empty::MergeFrom(const Empty& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:first_package.Empty)
  if (GOOGLE_PREDICT_FALSE(&from == this)) {
    ::google::protobuf::internal::MergeFromFail(__FILE__, __LINE__);
  }
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
...
// @@protoc_insertion_point(generalized_copy_from_start:first_package.Empty)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:first_package.Empty)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void Empty::clear_id() {
 ...
 ::google::protobuf::int32 Empty::id() const {
  // @@protoc_insertion_point(field_get:first_package.Empty.id)
  return id_;
}
 void Empty::set_id(::google::protobuf::int32 value) {
  set_has_id();
  id_ = value;
  // @@protoc_insertion_point(field_set:first_package.Empty.id)
}
